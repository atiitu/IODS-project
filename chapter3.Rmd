...
+) and first grade (G1) associate with the use of alcohol (low or high). I hypothesize that:<br/>
...
Last I hypotethized that lower first grades are associated with high alcohol use. This was true (p = 0.004, OR(97.5%CI):0.88(0.81,0.96)) wiht odds ratios telling 
